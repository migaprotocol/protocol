...
interface ParsIdentity {
  id: string;           // Anonymous identifier (hash)
  handle: string;       // Human-readable (e.g., @azadi.pars)
  publicKey: string;    // Encryption public key
  createdAt: number;
  // Encrypted attributes (only owner can decrypt)
...
interface IdentityFormData {
  ...
  duressPassword: string;  // Shows decoy identity under coercion
  deadManDays: number;     // Days before dead man's switch triggers
}
...
function isValidHandle(handle: string): boolean {
  // 3-32 chars, alphanumeric + underscore, no consecutive underscores
...
export function ParsIdentityMint() {
  ...
  // Intro screen - explain coercion resistance
  if (step === 'intro') {
    return (
      <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 max-w-lg mx-auto">
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="p-4 bg-neutral-800/50 rounded-lg">
            ...
            <p className="text-xs text-neutral-400">
              ...
              alerts trusted contacts. Protects against detention and forced disappearance.
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full py-3 px-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-medium rounded-lg hover:from-emerald-600 hover:to-emerald-700 transition-all"
        >
    ...
    return (
      <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 max-w-lg mx-auto">
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                placeholder="azadi"
                className="flex-1 bg-neutral-800/50 border border-neutral-700 rounded-lg px-3 py-2 text-white focus:border-emerald-500 focus:outline-none"
                maxLength={32}
              />
        ...
        <button
          ...
          className="w-full mt-6 py-3 px-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-medium rounded-lg hover:from-emerald-600 hover:to-emerald-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
        >
  ...
  // Security setup (duress code + dead man's switch)
  if (step === 'security') {
    return (
      <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 max-w-lg mx-auto">
        <button
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-neutral-800/50 border border-neutral-700 rounded-lg px-3 py-2 text-white focus:border-emerald-500 focus:outline-none"
            />
  ...
  if (step === 'confirm') {
    return (
      <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 max-w-lg mx-auto">
        ...
        <p className="text-sm text-neutral-400 mb-6">
          Review your identity before minting to the blockchain.
        </p>

        <div className="space-y-4 mb-6">
          <div className="p-4 bg-neutral-800/50 rounded-lg">
            <div className="text-sm text-neutral-400 mb-1">Identity</div>
            <div className="text-lg font-bold text-emerald-400">@{formData.handle}.pars</div>
          </div>
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full py-3 px-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white font-medium rounded-lg hover:from-emerald-600 hover:to-emerald-700 transition-all disabled:opacity-50"
        >
    ...
    return (
      <div className="bg-neutral-900/50 border border-neutral-800 rounded-xl p-6 max-w-lg mx-auto">
        <div className="text-center mb-6">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-emerald-500/20 to-emerald-600/20 flex items-center justify-center mx-auto mb-4">
            <Check className="w-8 h-8 text-emerald-400" />
          </div>
          <h2 className="text-2xl font-bold text-emerald-400">{identity.handle}</h2>
          <p className="text-sm text-neutral-400 mt-1">Your identity is live on-chain</p>
        </div>
